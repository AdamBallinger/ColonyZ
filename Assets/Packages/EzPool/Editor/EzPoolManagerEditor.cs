...
namespace EzPool
{
    ...
    public class EzPoolManagerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            pooledObj.objectReferenceValue = EditorGUILayout.ObjectField("Pooled Prefab",
                pooledObj.objectReferenceValue, typeof(GameObject), false);
            ...
            if (maxPoolCount.intValue < 1) serializedObject.FindProperty("maxPoolCount").intValue = 1;
            ...
            ProgressBar((float) Target.GetPoolCount() / maxPoolCount.intValue,
                $"Pooled Object Count : {Target.GetPoolCount()}");
            ProgressBar(activeObjCount / maxPoolCount.intValue,
                $"Active Pool Objects : {activeObjCount}/{maxPoolCount.intValue}");
            ProgressBar(inactiveObjCount / maxPoolCount.intValue,
                $"Inactive Pool Objects : {inactiveObjCount}/{maxPoolCount.intValue}");
